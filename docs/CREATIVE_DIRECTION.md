...
- Navigation and audio chrome remain unboxed: a black-and-acid-yellow `108Y` return mark and an icon-only speaker/mute target float directly on the composition.
