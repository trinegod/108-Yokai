...
- Navigation and audio chrome remain unboxed: an all-black `108Y` return mark and an icon-only speaker/mute target float directly on the composition. The `Y` retains the same typography, scale, weight, and spacing as the numerals.
