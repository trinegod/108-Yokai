...
- Motion-on CSS keeps fluorescent instability, three displaced image slices, moving grain, and the wordmark blur echo continuously active. Reduced-motion CSS removes the animated atmosphere and displaced slices, while the visible motion control can disable the treatment independently.
