...
- The mobile-only editorial inset frame is absent. A static 0.2% centered bleed covers the sub-pixel aspect-ratio seam; the source master remains untouched and the rendered page retains zero horizontal overflow.
