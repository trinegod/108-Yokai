...
- The speaker control and `108Y` return mark have no visible border or panel. The `108` remains black, the final `Y` uses the portal's acidic yellow, and both controls retain accessible names and focus outlines.
